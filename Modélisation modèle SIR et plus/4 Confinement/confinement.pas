...
const Xmax           = 19;
	  ...
	  placesH		 =100;				//places dispo à l'hopital
   taux_confinement  =0.80;				//taux de saturation des hopitaux pour lancer un confinement
   taux_deconfinement=0.05;				//taux de saturation des hopitaux pour lancer un déconfinement
	  omega          =0.9;				//pourcentage de la pop confinée
...
{
nom := 'export.txt';					//exporter quelques valeures 
